...
function ConfirmPasswordChangePageContent() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE}/api/auth/password-change/confirm/`, {
      method: 'POST',
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-10 max-w-md w-full text-center">
        {state === 'loading' && (
          <>
            ...
            <h2 className="text-xl font-bold text-neutral-900">Confirming password change…</h2>
...
export default function ConfirmPasswordChangePage() {
  return (
    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4">
      ...
      <ConfirmPasswordChangePageContent />
    </Suspense>
  );
}
