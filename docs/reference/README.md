# MomentumQuest design references

Saved on 18 August 2026 from the user-provided project artifacts.

- `MomentumQuest_FDD.pdf` — Functional Decomposition Diagram (FDD).
- `MomentumQuest_ERD.jpg` — Entity Relationship Diagram (ERD).
...
- `D:\FYP1\Presentation Canva\FDD (5).pdf`
- `D:\FYP1\Presentation Canva\Entity Relationship Diagram (4).jpg`
